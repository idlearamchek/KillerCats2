...
- (BOOL) isEqual:(id)color
{
    ...
    ccColor3B c3b0 = self.ccColor3b;
    ccColor3B c3b1 = ((CCColor*)color).ccColor3b;
    
//    ccColor4F c4f0 = self.ccColor4f;
//    ccColor4F c4f1 = ((CCColor*)color).ccColor4f;

//    BOOL isEqual = XZccc4FEqual(c4f0, c4f1);
    
    BOOL isEqual = ccc3BEqual(c3b0, c3b1);
...
static inline BOOL XZccc4FEqual(ccColor4F a, ccColor4F b)
{
    return fabs(a.r - b.r) < 0.01 && fabs(a.g - b.g) < 0.01 && fabs(a.b - b.b) < 0.01;
}
